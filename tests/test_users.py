...
class UsersTests(unittest.TestCase):
    ...
    def test_invalid_username_registration(self):
        ...
        response2 = self.register('ttttttttttttttttttttest', 'test@example.com', 'FlaskIsAwesome')
    ...
    def test_invalid_email_registration(self):
        ...
        response2 = self.register('test3', 'test@example2', 'FlaskIsStraight')
        self.assertIn(b'Invalid email address.', response.data)
        self.asserIn(b'Invalid email address.', response2.data)
